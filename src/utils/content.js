...
// Section3
import InstagramImg from "../assets/images/section3/instagram.png";
import FacebookImg from "../assets/images/section3/facebook.png";
import LinkedInImg from "../assets/images/section3/linkedin.png";
import YoutubeImg from "../assets/images/section3/youtube.png";
import TiktokImg from "../assets/images/section3/tiktok.png";
import TwitterImg from "../assets/images/section3/twitter.png";
...
// Navbar
import Logo from "../assets/images/logos/superCreatorLogo.png";
...
export const section2Content = {
  items: [
    { counter: 345, subtitle: "AI Generated content" },
    { counter: 345, before: "", after: "B+", subtitle: "Total content" },
    { counter: 4.4, after: "M+", subtitle: "Total posts created", decimals: true },
    { counter: 28.7, after: "M+", subtitle: "Total accounts", decimals: true },
  ],
};

export const section3Content = {
  title: "Create quality content which works across all social media platforms",
  ITEMS: [
    { logo: InstagramImg, name: "Instagram" },
    { logo: FacebookImg, name: "Facebook" },
    { logo: LinkedInImg, name: "LinkedIn" },
    { logo: YoutubeImg, name: "YouTube" },
    { logo: TiktokImg, name: "Tiktok" },
    { logo: TwitterImg, name: "Twitter" }
...
export const section5Content = {
  ...
  subtitle:
    "Generate unique content with AI with a click of a button",
};
